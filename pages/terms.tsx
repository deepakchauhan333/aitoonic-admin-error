...
export default function Terms() {
  return (
    <Layout>
      <Head>
        <title>Terms & Conditions | Aitoonic</title>
        <meta name="description" content="Terms and conditions for using Aitoonic - AI tools directory and marketplace." />
        <meta property="og:title" content="Terms & Conditions | Aitoonic" />
        <meta property="og:description" content="Terms and conditions for using Aitoonic - AI tools directory and marketplace." />
